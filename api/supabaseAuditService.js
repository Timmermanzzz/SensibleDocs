...
class SupabaseAuditService {
  constructor() {
    ...
    if (!supabaseUrl || !supabaseKey) {
      ...
      console.log('✅ Supabase audit service initialized')
      this.initializeDemoData()
    }
  }
  ...
  async logEvent(eventData) {
    try {
      ...
      if (this.supabase) {
        ...
        console.log(`✅ Audit Event Logged to Supabase: ${eventData.eventType} by ${eventData.userId}`)
        return data[0]
      } else {
        ...
        console.log(`✅ Audit Event Logged (in-memory): ${eventData.eventType} by ${eventData.userId}`)
        return auditEvent
      }
    } catch (error) {
  ...
  async initializeDemoData() {
    try {
      ...
      console.warn('⚠️ Could not initialize demo data:', error.message)
    }
  }
...
module.exports = new SupabaseAuditService() 